...
- Base: Performs the incremental logic, outputting the table `snowplow_identities_base_events_this_run` which contains a de-duped data set of all events required for the current run of the model.

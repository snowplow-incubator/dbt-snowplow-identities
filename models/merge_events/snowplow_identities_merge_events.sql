...
{{ config(
    ...
    meta={'upsert_date_key': 'derived_tstamp', 'snowplow_optimize': true}
) }}

select
    *
    {{ snowplow_identities.databricks_partition_date('derived_tstamp') }}

from {{ ref('snowplow_identities_merge_events_this_run') }}
